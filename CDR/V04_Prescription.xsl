						...
						<section>
							...
							<entry>
								<substanceAdministration classCode="SBADM" moodCode="EVN">
									...
									<!--药物剂型 -->
									<administrationUnitCode code="47" displayName="灌汤剂" codeSystem="2.16.156.10011.2.3.1.211" codeSystemName="药物剂型代码表"/>
									<consumable>
										<manufacturedProduct>
									...
									<entryRelationship typeCode="COMP">
										<observation classCode="OBS" moodCode="EVN">
											...
											<SumDoseQuantity value="{/Document/Medication1/DrugSpecifications}" unit="mg"/>
										</observation>
									</entryRelationship>
									<entryRelationship typeCode="COMP">
										<observation classCode="OBS" moodCode="EVN">
											...
											<value xsi:type="ST">
												<xsl:value-of select="/Document/Medication1/SumDoseQuantity"/>
											</value>
										</observation>
									</entryRelationship>
							...
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="INT" value="{/Document/Medication1/Group}"/>
								</observation>
							</entry>
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="ST">
										<xsl:value-of select="/Document/Medication1/Note"/>
									</value>
								</observation>
							</entry>
						</section>
