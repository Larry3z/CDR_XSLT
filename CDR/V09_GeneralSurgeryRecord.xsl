						...
						<section>
							...
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="ST"><xsl:value-of select="/Document/Encounter/VisitDescription1"/></value>
								</observation>
							</entry>
							<!--术中用药-->
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="ST"><xsl:value-of select="/Document/Encounter/VisitDescription2"/></value>
								</observation>
							</entry>
						</section>
					</component>
