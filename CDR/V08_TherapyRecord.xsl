								...
								<substanceAdministration classCode="SBADM" moodCode="EVN">
									...
									<entryRelationship typeCode="COMP">
										<observation classCode="OBS" moodCode="EVN">
											...
											<value xsi:type="ST"><xsl:value-of select="/Document/Medication1/OrderItem/Description"/></value>
										</observation>
									</entryRelationship>
									<!--中药使用类别代码-->
									<entryRelationship typeCode="COMP">
									...
									<entryRelationship typeCode="COMP">
										<observation classCode="OBS" moodCode="EVN">
											...
											<value xsi:type="ST"><xsl:value-of select="/Document/Medication1/DosageUnit"/></value>
										</observation>
									</entryRelationship>
									<!--药物使用总剂量-->
									<entryRelationship typeCode="COMP">
										<observation classCode="OBS" moodCode="EVN">
											...
											<value xsi:type="PQ" value="{/Document/Medication1/SumDoseQuantity}" unit="g"/>
										</observation>
									</entryRelationship>
