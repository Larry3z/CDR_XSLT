...
<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:isc="http://extension-functions.intersystems.com" xmlns:exsl="http://exslt.org/common" xmlns:set="http://exslt.org/sets" exclude-result-prefixes="isc sdtc exsl set">
	...
	<!-- 其他参与者签名 -->
	<!--xsl:template match="Practitioner1" mode="Authenticator1">
	...
	<xsl:template match="Practitioner" mode="Authenticator">
	...
	<xsl:template match="*" mode="Linkman">
	...
	<xsl:template match="*" mode="serviceEvent">
	 <xsl:comment>手术或分娩后天数</xsl:comment> 
		<documentationOf>
				<serviceEvent>
					<code/>
					<effectiveTime>
						<!--手术或分娩后天数-->
						<width value="{width}" unit="天"/>
					</effectiveTime>
				</serviceEvent>
			</documentationOf>
	</xsl:template>
					...
					<serviceProviderOrganization>
						<asOrganizationPartOf classCode="PART">
							...
							<wholeOrganization classCode="ORG" determinerCode="INSTANCE">
								...
								<name>
									<xsl:value-of select="Hospitalization/Location/bed"/>
								</name>
								<!-- DE01.00.019.00病房号 -->
								<asOrganizationPartOf classCode="PART">
									<wholeOrganization classCode="ORG" determinerCode="INSTANCE">
										...
										<name>
											<xsl:value-of select="Hospitalization/Location/room"/>
										</name>
										<!-- DE08.10.026.00科室名称 -->
										<asOrganizationPartOf classCode="PART">
											<wholeOrganization classCode="ORG" determinerCode="INSTANCE">
												...
												<name>
													<xsl:value-of select="AdmissionLocation"/>
												</name>
												<!-- DE08.10.054.00病区名称 -->
												<asOrganizationPartOf classCode="PART">
													<wholeOrganization classCode="ORG" determinerCode="INSTANCE">
														...
														<name>
															<xsl:value-of select="Hospitalization/Location/ward"/>
														</name>
														<!--XX医院 -->
														<asOrganizationPartOf classCode="PART">
															<wholeOrganization classCode="ORG" determinerCode="INSTANCE">
																...
																<name>
																	<xsl:value-of select="HealthCareFacility"/>
																</name>
															</wholeOrganization>
